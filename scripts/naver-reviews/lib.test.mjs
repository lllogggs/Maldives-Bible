...
test('conservatively accepts snippets with resort identity and direct stay details', () => {
  const samples = [
    {
      resort: { name: '오젠 리저브 볼리푸시', name_en: 'OZEN RESERVE BOLIFUSHI' },
    ...
    {
      resort: { name: '푸라베리 아일랜드 리조트 & 스파', name_en: 'Furaveri Maldives' },
      title: '신혼여행 몰디브 DAY 3, 푸라베리 아일랜드 리조트 & 스파',
      description: '워터빌라로 옮겨 3박을 보냈고 바다 풍경이 정말 좋았어요.',
    },
    {
      resort: { name: '릴리 비치 리조트 & 스파', name_en: 'Lily Beach Resort & Spa' },
      title: '몰디브 릴리 비치 리조트 & 스파 수중환경 후기',
      description: '저희 부부는 5박 6일 일정으로 다녀왔고 워터빌라에서 숙박했어요.',
    },
    {
      resort: { name: '인터컨티넨탈 몰디브 마무나가우', name_en: 'InterContinental Maldives Maamunagau' },
    ...
    {
      resort: { name: '아다란 프레스티지 바두', name_en: 'Adaaran Prestige Vadoo' },
...
test('rejects sales, reposts, planning posts, professional inspections, and resort mismatches', () => {
  const samples = [
    ...
    {
      resort: { name: '아난타라 키하바 빌라', name_en: 'Anantara Kihavah Villas' },
      title: '신혼여행 준비 2편 아난타라 키하바 빌라 후보 20곳 비교 후기',
      description: '후기를 볼 때마다 예쁘다고 느꼈던 후보를 정리합니다.',
    },
    {
      resort: { name: '애트모스피어 카니푸시 몰디브', name_en: 'Atmosphere Kanifushi Maldives' },
    ...
    {
      resort: { name: '콘스탄스 할라벨리 리조트', name_en: 'Constance Halaveli' },
    ...
    {
      resort: { name: '알릴라 코타이파루 몰디브', name_en: 'Alila Kothaifaru Maldives' },
