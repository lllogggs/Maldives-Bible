        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm flex flex-col">
                ...
                <div className="flex-grow flex flex-col">
                    <div className="flex items-center justify-center min-h-[96px] sm:min-h-[128px]">
                        <div className="flex flex-wrap items-center justify-center gap-1 sm:gap-4 text-center w-full max-w-full">
                            <div className="flex flex-col items-center gap-1 flex-1 min-w-[32px] sm:min-w-[48px]">
                                <BuildingIcon className="h-6 w-6 sm:h-12 sm:w-12 text-blue-600" />
                                <span className="font-semibold text-[9px] sm:text-sm">리조트</span>
                            </div>
                            <div className="flex flex-col items-center text-gray-500 px-1 sm:px-2 flex-[0.6] min-w-[28px] sm:min-w-[40px]">
                                <ChevronRightIcon className="h-3 w-3 sm:h-6 sm:w-6" />
                                <span className="text-[10px] sm:text-sm font-bold mt-1 text-red-500">$10,000</span>
                                <span className="text-[9px] sm:text-xs font-semibold text-gray-500 mt-1">공시가</span>
                            </div>
                            <div className="flex flex-col items-center gap-1 flex-1 min-w-[32px] sm:min-w-[48px]">
                                <UserIcon className="h-6 w-6 sm:h-12 sm:w-12 text-cyan-600" />
                                <span className="font-semibold text-[9px] sm:text-sm">고객</span>
                            </div>
                        </div>
                    </div>
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm flex flex-col">
                ...
                <div className="flex-grow flex flex-col">
                    <div className="flex items-center justify-center min-h-[96px] sm:min-h-[128px]">
                        <div className="flex flex-wrap items-center justify-center gap-1 sm:gap-3 lg:gap-4 text-center w-full max-w-full">
                            <div className="flex flex-col items-center gap-1 flex-1 min-w-[32px] sm:min-w-[48px]">
                                <BuildingIcon className="h-6 w-6 sm:h-11 sm:w-11 text-blue-600" />
                                <span className="font-semibold text-[9px] sm:text-sm">리조트</span>
                            </div>
                            <div className="flex flex-col items-center text-gray-500 px-1 sm:px-2 flex-[0.55] min-w-[26px] sm:min-w-[38px]">
                                <ChevronRightIcon className="h-3 w-3 sm:h-6 sm:w-6" />
                                <span className="text-[10px] sm:text-sm font-bold mt-1 text-gray-700">$6,000</span>
                                <span className="text-[9px] sm:text-xs font-semibold text-gray-500 mt-1">도매가</span>
                            </div>
                            <div className="flex flex-col items-center gap-1 flex-1 min-w-[36px] sm:min-w-[54px]">
                                <BuildingIcon className="h-6 w-6 sm:h-11 sm:w-11 text-green-600" />
                                <span className="font-semibold text-[9px] sm:text-sm leading-tight">한국 총판<br />(GSA)</span>
                            </div>
                            <div className="flex flex-col items-center text-gray-500 px-1 sm:px-2 flex-[0.55] min-w-[26px] sm:min-w-[38px]">
                                <ChevronRightIcon className="h-3 w-3 sm:h-6 sm:w-6" />
                                <span className="text-[10px] sm:text-sm font-bold mt-1 text-gray-700">$7,500</span>
                            </div>
                            <div className="flex flex-col items-center gap-1 flex-1 min-w-[32px] sm:min-w-[48px]">
                                <BuildingIcon className="h-6 w-6 sm:h-11 sm:w-11 text-purple-600" />
                                <span className="font-semibold text-[9px] sm:text-sm">여행사</span>
                            </div>
                             <div className="flex flex-col items-center text-gray-500 px-1 sm:px-2 flex-[0.55] min-w-[26px] sm:min-w-[38px]">
                                <ChevronRightIcon className="h-3 w-3 sm:h-6 sm:w-6" />
                                <span className="text-[10px] sm:text-sm font-bold mt-1 text-cyan-600">$8,500</span>
                            </div>
                            <div className="flex flex-col items-center gap-1 flex-1 min-w-[32px] sm:min-w-[48px]">
                                <UserIcon className="h-6 w-6 sm:h-11 sm:w-11 text-cyan-600" />
                                <span className="font-semibold text-[9px] sm:text-sm">고객</span>
                            </div>
                        </div>
                    </div>
